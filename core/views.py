...
def index(request):
    ...
    my_dict = {'user_profile':user_profile,'posts':feed_lists,'suggestions_username_profile_list':suggestions_username_profile_list[:4]}
...
#         # Optionally, create a new profile for the user if it's expected
